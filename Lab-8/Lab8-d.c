...
// no flow control
// Clock: ACLK 32kHz, no oversampling
void initialize_UART_2(void){
    ...
    // Use SMCLK clock; leave other settings default
    UCA1CTLW0 |= UCSSEL_1; //CHANGE 1 (uses ACLK)

    // Configure the clock dividers and modulators
    // UCBR=6, UCBRF= Don't Care, UCBRS=0xEE, UCOS16=0 (no oversampling)
    UCA1BRW = 6;
    UCA1MCTLW = UCBRS7 | UCBRS6 | UCBRS5 | UCBRS3 | UCBRS2 | UCBRS1; // = 0xEE
