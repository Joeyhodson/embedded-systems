//Program reads specific internal register values from the BoosterPack’s light sensor and prints the data over UART
...
int main(void) {
    ...
    unsigned char i2c_reg1 = 0x7E;
    unsigned char i2c_reg2 = 0x7F;
    unsigned char i2c_address = 0x44;
    ...
    while(1) {
        ...
        i2c_read_word(i2c_address, i2c_reg1, &data);
        dec_to_hex(&data);
        uart_write_uint16(data);
        uart_write_char(' ');

        i2c_read_word(i2c_address, i2c_reg2, &data);
        dec_to_hex(&data);
        uart_write_uint16(data);
        uart_write_char('\n');
        uart_write_char('\r');
